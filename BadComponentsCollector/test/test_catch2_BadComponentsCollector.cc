...
static constexpr auto s_tag = "[BadComponentsCollector]";

TEST_CASE("Standard checks of BadComponentsCollector", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("BadComponentsCollector"
